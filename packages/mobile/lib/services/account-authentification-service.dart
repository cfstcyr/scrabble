...
class AccountAuthenticationService {
  ...
  static final AccountAuthenticationService _instance = AccountAuthenticationService._privateConstructor();

  factory AccountAuthenticationService() {
    return _instance;
  }
  // final headers = {"Content-type": "application/json"};
  final accountAuthenticationController = getIt.get<AccountAuthenticationController>();
