...
export const DAILY_PUZZLE_MESSAGE_FIRST = 'Vous êtes le premier dans le classement!';
export const DAILY_PUZZLE_MESSAGE_IN_LEADERBOARD = 'Vous êtes dans le classement!';
export const DAILY_PUZZLE_MESSAGE_NOT_IN_LEADERBOARD = (rank: number, total: number) => `Vous êtes ${rank}e sur ${total} joueurs.`;
export const DAILY_PUZZLE_MESSAGE_NOT_WON = "Vous n'avez pas réussi le puzzle du jour";
